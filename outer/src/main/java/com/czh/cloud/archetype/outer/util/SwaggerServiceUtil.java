...
import com.czh.cloud.archetype.outer.service.impl.SwaggerServiceClient;
...
public class SwaggerServiceUtil {
     ...
     * @return: com.czh.cloud.common.entity.RootResponse<com.czh.cloud.archetype.outer.entity.response.SwaggerRep>
     */
